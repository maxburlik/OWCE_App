...
namespace OWCE.Pages
{
    public partial class SettingsPage : ContentPage
    {
        ...
        public SettingsPage()
        {
            ...
            BatteryPercentInferredBasedOnVoltage.IsToggled = App.Current.BatteryPercentInferredBasedOnVoltage; // TODO: Enable calculations, front page description main indicator based on voltage
            WheelslipReporting.IsToggled = App.Current.WheelslipReporting;

            lastValidSpeedReportingMinimum = App.Current.SpeedReportingMinimum;
        ...
        private void SpeedDemon_Toggled(object sender, Xamarin.Forms.ToggledEventArgs e)
        {
